<?php
	...
	$curp = $_POST['curp'];
    $registro = $conexion->query("SELECT A.al_id, A.al_estatus FROM tramite_baja B INNER JOIN SCE004 A ON A.al_curp = B.curp  WHERE curp = '$curp'");

	foreach($registro as $fila){
        
	    $idAlumno = $fila['al_id'];
	    $estatus = $fila['al_estatus'];	   

	  }


    $api_url = 'https://sce-usebeq-api.azurewebsites.net/api/boletas/'.$idAlumno;//produccion
