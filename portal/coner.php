<?php 
  ...
  if (isset($_GET['id'])) {
    ...
    elseif ($fecha == 2023) {
      ...
      $codigo = $_GET['cod'];
      $busqueda = $conexion->query("SELECT folio FROM constancia_regularizacion WHERE al_id = '$al_id' AND fecha_periodo = '$codigo'");

      foreach($busqueda as $fila2){
        $folio = $fila2['folio'];
      }
                  ...
                  <div class="row justify-content-center">
                    ...
                    <?php } if ($con == 'SI') { ?>
                      ...
                      <form action="../index.php">
                        ...
                        <div class="row col-line justify-content-center">
                          <h4 align="center" class="">La lectura del código QR vincula al educando <b><?php echo $nombre." ".$appat." ".$apmat ?></b> con CURP <b><?php echo $al_curp ?></b>, como alumno (a) acreedor (a) del documento constancia de examen de regularización con folio: <b><?php echo $folio ?></b>.</h4>
                          <br>
                        </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2023 <a href="https://www.usebeq.edu.mx/PaginaWEB/" class="font-weight-bold ml-1" target="_blank">USEBEQ</a>
            </div>
          </div>
          <div class="col-xl-6">
