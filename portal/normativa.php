                      ...
                      <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="img/inscripcion.jpg" class="d-block h-100" alt="...">
                          </div>
                          <div class="carousel-item">
                            <img src="img/regularizacion.jpeg" class="d-block h-100" alt="...">
                          </div>
                          <div class="carousel-item">
                            <img src="img/ingreso.jpeg" class="d-block h-100" alt="...">
                          </div>
                        </div>
