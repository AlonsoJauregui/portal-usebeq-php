            ...
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-12 text-center">
                  <h3 class="mb-0">Duplicado de Certificados en Línea</h3>
                </div>
              </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <select class="form-control form-control-alternative" name="entrada" id="entrada">
                          ...
                          <option value="Estatus">Estatus del trámite</option>
                          <option value="Duplicado Certificado de Preescolar">Duplicado Certificado de Preescolar</option>
                          <option value="Duplicado Certificado de Primaria">Duplicado Certificado de Primaria</option>
                          <option value="Duplicado Certificado de Secundaria">Duplicado Certificado de Secundaria</option>
