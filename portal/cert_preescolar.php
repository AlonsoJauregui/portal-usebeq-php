<?php 
	...
	$tipo_tramite = "CERTIFICADO DE PREESCOLAR";
	...
	if ( $longitud_curp == '18' ) {	
		...
		/*$verifica_certificado = $conexion->query("SELECT COUNT(*) AS CER FROM SCE039 WHERE al_curp = '$curp' AND nivel = 'PRE'");
		...
		if ($estado_cct == 22 AND ($nivel_cct == 'DJN' OR $nivel_cct == 'PJN' OR $nivel_cct == 'DCC' OR $nivel_cct == 'DML' OR $nivel_cct == 'EJN')) {
				...
				if ($check == "SI") {
					...
					switch ($caso) {
						case 1:
							...
							$responsable = $conexion -> query("SELECT * FROM RESPONSABLES WHERE CLAVE = '$cct' AND NIVEL = 'PRE'");
						...
						if ($val_tram == 0) {
							...
							if ($respuesta !== false) {
								...
								if ($ciclo_terminacion == "2000-2001" or $ciclo_terminacion == "2001-2002" or $ciclo_terminacion == "2002-2003" or $ciclo_terminacion == "2003-2004" or $ciclo_terminacion == "2004-2005" or $ciclo_terminacion == "2005-2006" or $ciclo_terminacion == "2006-2007" or $ciclo_terminacion == "2007-2008" or $ciclo_terminacion == "2008-2009" or $ciclo_terminacion == "2009-2010" or $ciclo_terminacion == "2010-2011" or $ciclo_terminacion == "2011-2012" or $ciclo_terminacion == "2012-2013" or $ciclo_terminacion == "2013-2014" or $ciclo_terminacion == "2014-2015" or $ciclo_terminacion == "2015-2016" or $ciclo_terminacion == "2016-2017" or $ciclo_terminacion == "2017-2018" or $ciclo_terminacion == "2018-2019" or $ciclo_terminacion == "2019-2020" or $ciclo_terminacion == "2020-2021" or $ciclo_terminacion == "2021-2022" or $ciclo_terminacion == "2022-2023" or $ciclo_terminacion == "2023-2024" or $ciclo_terminacion == "2024-2025") {
									...
									$statement = $conexion->prepare('INSERT INTO tramites1 (folio, nombre_alumno, a_paterno, a_materno, telefono, email, curp, cct, nombre_esc, dom_esc, turno, ciclo_terminacion, tipo_tramite, usuario, foto, zona, sector, fecha, status, region, core) VALUES (:folio, :nombre_alumno, :a_paterno, :a_materno, :telefono, :email, :curp, :cct, :nombre_esc, :dom_esc, :turno, :ciclo_terminacion, :tipo_tramite, :usuario, :foto, :zona, :sector, :fecha, :status, :region, :core)');

									$statement->execute(array(":folio"=>$folio, ":nombre_alumno"=>$nombre_alumno, ":a_paterno"=>$a_paterno, ":a_materno"=>$a_materno, ":telefono"=>$tel, ":email"=>$email, ":curp"=>$curp, ":cct"=>$cct, ":nombre_esc"=>$nombre_esc, ":dom_esc"=>$dom_esc, ":turno"=>$turno, ":ciclo_terminacion"=>$ciclo_terminacion, ":tipo_tramite"=>$tipo_tramite, ":usuario"=>$usuario, ":foto"=>$foto, ":zona"=>$zona, ":sector"=>$sector, ":fecha"=>$fecha, ":status"=>$status, ":region"=>$region, ":core"=>$core));
									$resultado = $statement -> fetch();
									...
									$statement = $conexion->prepare('INSERT INTO tramites1 (folio, nombre_alumno, a_paterno, a_materno, telefono, email, curp, cct, nombre_esc, dom_esc, turno, ciclo_terminacion, tipo_tramite, foto, zona, sector, fecha, status, region, core) VALUES (:folio, :nombre_alumno, :a_paterno, :a_materno, :telefono, :email, :curp, :cct, :nombre_esc, :dom_esc, :turno, :ciclo_terminacion, :tipo_tramite, :foto, :zona, :sector, :fecha, :status, :region, :core)');

									$statement->execute(array(":folio"=>$folio, ":nombre_alumno"=>$nombre_alumno, ":a_paterno"=>$a_paterno, ":a_materno"=>$a_materno, ":telefono"=>$tel, ":email"=>$email, ":curp"=>$curp, ":cct"=>$cct, ":nombre_esc"=>$nombre_esc, ":dom_esc"=>$dom_esc, ":turno"=>$turno, ":ciclo_terminacion"=>$ciclo_terminacion, ":tipo_tramite"=>$tipo_tramite, ":foto"=>$foto, ":zona"=>$zona, ":sector"=>$sector, ":fecha"=>$fecha, ":status"=>'SOLICITADO SIN RESPONSABLE', ":region"=>$region, ":core"=>$core));
									$resultado = $statement -> fetch();
		...
		$val_tram = 9;
		$mensaje = "La CURP que ingresa no cuenta con los 18 dígitos, favor de realizar nuevamente su trámite con la corrección.";
	}
		...
		//if ($ciclo_terminacion == "2014-2015" OR $ciclo_terminacion == "2015-2016" OR $ciclo_terminacion == "2016-2017" OR $ciclo_terminacion == "2017-2018" OR $ciclo_terminacion == "2018-2019") {
			// validacion para ciclos electronicos
		//}
			...
			<div class="card bg-secondary shadow">
				...
				<div class="card-body">
					...
					<div class="row">
						...
						<?php } elseif ($val_tram == 5) { ?>

							<div class="row col-12 justify-content-center">
								<h4 align="center" class="">El alumno (a) egresó de PREESCOLAR en el ciclo escolar 2022 - 2023 por lo tanto para consulta y descarga de sus documentos de acreditación ingrese a: <a href="http://portal.usebeq.edu.mx">portal.usebeq.edu.mx</a></h4>
								<br>
							</div>
						...
						<?php } elseif ($val_tram == 6) { ?>

							<div class="row col-12 justify-content-center">
								<h4 align="center" class="">El alumno (a) se encuentra inscrito en PREESCOLAR para consulta y descarga de boletas de evaluación ingrese a: <a href="http://portal.usebeq.edu.mx">portal.usebeq.edu.mx</a></h4>
								<br>
							</div>
						...
						<?php } elseif ($val_tram == 8) { ?>

							<div class="row col-12 justify-content-center">
								<h4 align="center" class="">La clave de la escuela ingresada no corresponde a PREESCOLAR, favor de seleccionar el nivel correcto del trámite a realizar en el menú de solicitud de duplicados de certificado.</a></h4>
								<br>
							</div>
