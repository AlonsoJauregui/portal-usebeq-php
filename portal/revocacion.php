											...
											if ($region == 1){
												...
												if( $tipo_cct == 'DML' || $tipo_cct == 'PIV'){
													...
													if ($nivel == 'PREESCOLAR' || $nivel == 'PRIMARIA'){
														$usuario1 = $conexion -> query("SELECT * FROM tramite_revocaciong WHERE region = '4' AND responsable <> 'ahurtado' AND nivel IN ('PREESCOLAR','PRIMARIA') AND responsable = 'eugalde' AND YEAR(fecha_solicitud) = $year_act");
														$cant_usu1 = $usuario1->rowCount();
														$usuario2 = $conexion -> query("SELECT * FROM tramite_revocaciong WHERE region = '4' AND responsable <> 'ahurtado' AND nivel IN ('PREESCOLAR','PRIMARIA') AND responsable = 'arangelp' AND YEAR(fecha_solicitud) = $year_act");
														$cant_usu2 = $usuario2->rowCount();
														$usuario3 = $conexion -> query("SELECT * FROM tramite_revocaciong WHERE region = '4' AND responsable <> 'ahurtado' AND nivel IN ('PREESCOLAR','PRIMARIA') AND responsable = 'mmartinezf' AND YEAR(fecha_solicitud) = $year_act");
														$cant_usu3 = $usuario3->rowCount();
														$usuario4 = $conexion -> query("SELECT * FROM tramite_revocaciong WHERE region = '4' AND responsable <> 'ahurtado' AND nivel IN ('PREESCOLAR','PRIMARIA') AND responsable = 'acoronar' AND YEAR(fecha_solicitud) = $year_act");
														...
														$usuario_min = $conexion -> query("SELECT TOP 1 responsable, COUNT(*) cantSol  FROM tramite_revocaciong WHERE region = '4' AND responsable <> 'ahurtado' AND nivel IN ('PREESCOLAR','PRIMARIA') AND responsable IN ('eugalde','arangelp','mmartinezf','acoronar') AND YEAR(fecha_solicitud) = $year_act GROUP BY responsable ORDER BY cantSol");
														foreach ($usuario_min as $dato_min) {
															$responsable = $dato_min['responsable'];
														}	
														}
													}elseif ($nivel == 'SECUNDARIA'){
														$usuario5 = $conexion -> query("SELECT * FROM tramite_revocaciong WHERE region = '4' AND responsable <> 'ahurtado' AND nivel = 'SECUNDARIA' AND responsable = 'agraciam' AND YEAR(fecha_solicitud) = $year_act");
														$cant_usu5 = $usuario5->rowCount();
														$usuario6 = $conexion -> query("SELECT * FROM tramite_revocaciong WHERE region = '4' AND responsable <> 'ahurtado' AND nivel IN ('SECUNDARIA') AND responsable = 'aortiz' AND YEAR(fecha_solicitud) = $year_act");
														$cant_usu6 = $usuario6->rowCount();
														$usuario7 = $conexion -> query("SELECT * FROM tramite_revocaciong WHERE region = '4' AND responsable <> 'ahurtado' AND nivel IN ('SECUNDARIA') AND responsable = 'hsalazar' AND YEAR(fecha_solicitud) = $year_act");
														...
														$usuario_min = $conexion -> query("SELECT TOP 1 responsable, COUNT(*) cantSol  FROM tramite_revocaciong WHERE region = '4' AND responsable <> 'ahurtado' AND nivel = ('SECUNDARIA') AND responsable IN ('agraciam','aortiz','hsalazar') AND YEAR(fecha_solicitud) = $year_act GROUP BY responsable ORDER BY cantSol");
														foreach ($usuario_min as $dato_min) {
															$responsable = $dato_min['responsable'];
														}
														}
