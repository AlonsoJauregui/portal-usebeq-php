	...
	$llenado = "<form action='cert_preescolar.php' method='POST' onsubmit='return checkSubmit();'>
					...
					<div class='row'>
						...
						<div class='col-lg-5 form-group'>
							...
							<input class='form-control form-control-alternative' type='text' name='dom_esc' id='dom_esc' placeholder='Domicilio..' maxlength='70'>
						</div>
						<div class='col-lg-3 form-group'>
	...
	$llenado = "<form action='baja_reg.php' method='POST' enctype='multipart/form-data' onsubmit='return checkSubmit();'>
					...
					<div class='row'>
						...
						<div class='col-lg-2 form-group'>
							...
							<input class='form-control form-control-alternative' type='number'  min='1' max='6' name='grado' id='grado' placeholder='Grado' required>
						</div>
						<div class='col-lg-2 form-group'>
						...
						<div class='row col-12 justify-content-center'>
	                      ...
	                      <h4 align='center' class=''><b class='text-danger'>Los formatos permitidos para la carga de documentos son PNG, JPEG Y JPG, con un peso máximo de 500 KB.</b></h4>
	                    </div>
						<div class='col-lg-4 form-group'>
							<label class='form-control-label'>Identificación del padre o tutor: (500 KB)*</label>
							<input class='' type='file' name='identificacion' id='identificacion' accept='image/*' required>
						</div>
						<div class='col-lg-4 form-group'>
							<label class='form-control-label'>Acta de Nacimiento del alumno: (500 KB)*</label>
							<input class='' type='file' name='acta' id='acta' accept='image/*' required>
						</div>
						<div class='col-lg-4 form-group'>
							<label class='form-control-label'>CURP del alumno: (500 KB)*</label>
...
if ($tramite == 'estatusRevocacion') {	
					...
					<div class='row'>
						<div class='row col-12 justify-content-center espacios'>
							<div class='col-lg-4 form-group'>
								...
								<input class='form-control form-control-alternative' type='text' name='folio' id='folio' placeholder='Ingresa el folio' maxlength='18' onkeyup='mayus(this)' required>
							</div>
						</div>
	...
	<div class='row'>
		...
		<div class='col-lg-4 form-group' >
			...
			<input class='form-control form-control-alternative' type='text' name='tel' id='tel' placeholder='Tel. Celular' maxlength='10' onpaste='return false' onkeypress='validate(event)' required>
		</div>
...
if ($tramite == 'estatus_revalidacion') {
	# code...
}
if ($tramite == 'solicitud_revalidacion'){
