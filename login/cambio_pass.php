<?php
	...
	$correo = base64_decode($_GET['user']);
...
<body>
	...
	<script>
	    function checkSubmit() {
	        document.getElementById("btsubmit").value = "Aplicando cambios...";
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: linear-gradient(to left, rgba(31, 43, 105, 0.7), rgba(79, 134, 176, 0.3)), url('images/img-01.jpg');">
			<div class="wrap-login100 p-t-70 p-b-30">
				<form action="pass_ok.php" method="POST" class="login100-form validate-form" onsubmit="return checkSubmit();">
					<div class="login100-form-title">
						<img width="250" src="images/USEBEQB.png" alt="AVATAR">
					</div>

					<span class="login100-form-title p-t-20 p-b-45">
						<h5 class="fs-17">Ingresa la nueva contraseña que deseas utilizar para <?php echo $correo; ?> en el Portal de Padres.</h5>
					</span>
					...
					<div class="container-login100-form-btn p-t-10">
						<input class="login100-form-btn1" type="submit" id="btsubmit" value="Cambiar contraseña" />
					</div>
